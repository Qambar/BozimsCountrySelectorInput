...
class BozimsCountrySelector {
    ...
    function iptocountry($ip) {    
        ...
        //var_dump($numbers);
        if ($numbers[0] == '::1') die('This script does not support localhost');
        ...
        return $this->userCountry = $this->countries[$country];
    }
    ...
    function getUserCountry() {
        if ($this->userCountry == null) {
            $this->iptocountry($this->ipAddress);
        }
